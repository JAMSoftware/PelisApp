...
public class MainActivity extends Activity {
	...
	private ServiceConnection mConnection = new ServiceConnection() {
		public void onServiceConnected(ComponentName className, IBinder service) {
			Log.e("ServiceBroadcastClientActivity",
					"onServiceConnected::Serviced connected");
			mService = new Messenger(service);
			Toast.makeText(MainActivity.this, "servicio conectado",
		...
		public void onServiceDisconnected(ComponentName className) {
			...
			mService = null;
			Toast.makeText(MainActivity.this, "servicio desconectado",
					Toast.LENGTH_SHORT).show();
		}
	};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * Codigo para crear las notificaciones del tipo status bar y
		 * mostrarlas.
		 */
		NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(
				this).setSmallIcon(R.drawable.logo)
				.setContentTitle("My Cataleg").setContentText("runnig!");
	...
	public void doBindService() {
		try {
			bindService(new Intent(this, MovieCatalogService.class),
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		Bundle b;
		/*
		 * Menu de opciones, cuando se selecciona un item en el menu se lanza un
		 * aviso en forma de dialogo.
		 */
		// Context context = getApplicationContext();
		switch (item.getItemId()) {
		case R.id.menu_save:
			b = new Bundle();
			msg = Message.obtain(null, MovieCatalogService.MSG_SAVE_CATALOG, 0,
					0);
			msg.setData(b);
			try {
				mService.send(msg);
		...
		case R.id.menu_paste:
			b = new Bundle();
			msg = Message.obtain(null, MovieCatalogService.MSG_RESTORE_CATALOG,
					0, 0);
			msg.setData(b);
			try {
				mService.send(msg);
		...
		case R.id.menu_pdf:
			Toast.makeText(MainActivity.this, "Pdf is Selected",
					Toast.LENGTH_SHORT).show();
			b = new Bundle();
			msg = Message.obtain(null,
					MovieCatalogService.MSG_RESTORE_CATALOG_BD, 0, 0);
			msg.setData(b);
			try {
				mService.send(msg);
			} catch (RemoteException e) {
		...
		case R.id.menu_screenshot:
			Toast.makeText(MainActivity.this, "Screenshot is Selected",
					Toast.LENGTH_SHORT).show();
			return true;

		case R.id.menu_searchgoogle:
			Toast.makeText(MainActivity.this, "Search in google is Selected",
					Toast.LENGTH_SHORT).show();
			return true;

		case R.id.menu_about:
			Toast.makeText(MainActivity.this, "About is Selected",
					Toast.LENGTH_SHORT).show();
			return true;
