...
public class AddFilm extends Activity {
    ...
    //Aquest mètode s'ha de sobreescriure quan es vol fer ús del menú d'opcions
    //ràpides de l'aplicació Android. Si no s'utilitza el menu, no s'ha de 
    //sobreescriure el mètode perquè llavors mostrarà el menú amb una opció per
    //defecte (Settings) que no tindrà cap funcionalitat.
    @Override
