...
public class AddFilm extends Activity {
    ...
    //Aquests dos métodes (alertbox1 i alertbox2) són idèntics, 
    //només varia l'string que es mostra. Caldria convertir-los 
    //en un i passar la referència a la cadena per paràmetre:
