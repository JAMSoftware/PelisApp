...
Permite al usuario la b�squeda de una pel�cula introduciendo su
t�tulo.
--------------------------------------------------------------- */
...
public class SearchFilm extends Activity{
	...
	//mètodes (Messengers, ServiceConnection, onBind...). Lo millor seria crear
	//una classe que extengues Activity i implementes tots aquests mètodes. Llavors, 
	//només caldria que les Activitats que haguessin de fer us del Servei extenguesin MyActivity
	//enlloc d'Activity, i no caldria defenir els mètodes i atributs cada vegada.
