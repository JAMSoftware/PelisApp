	        ...
	        public void handleMessage(Message msg) 
	        {
	            ...
	            switch (msg.what) 
	            {
	                ...
	                case MSG_SAVE_CATALOG:
	                    ...
	                    //Aqui tanques la DB, però enlloc la tornes a obrir. 
	                    //Si intentes llegir de DB després d'executar aquesta
	                    //funció, et trobaràs amb una DB tancaca i rebras una Excepció.
	                    db.close();
	                    try {
	        				oStream.flush();
